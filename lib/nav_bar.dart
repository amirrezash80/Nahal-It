           ...
           // backgroundColor: Color(0xff293525),
            ...
            items: const <BottomNavigationBarItem>[
              BottomNavigationBarItem(
                icon: Icon(Icons.person_2_outlined ,color: Color(0xff2e5c66),
               ),
                label: 'پروفایل',
              ...
              BottomNavigationBarItem(
                icon: Icon(Icons.menu , color: Color(0xff2e5c66),),
                label: 'همه دسته بندی ها',
                activeIcon: Icon(Icons.menu,color: Colors.green,)
              ),
              BottomNavigationBarItem(
                icon: Icon(Icons.shopping_cart_outlined , color: Color(0xff2e5c66),),
                label: 'سبد خرید',
                activeIcon: Icon(Icons.shopping_cart,color: Colors.green,)
              ),
              BottomNavigationBarItem(
                icon: Icon(Icons.receipt_long_rounded , color: Color(0xff2e5c66),),
